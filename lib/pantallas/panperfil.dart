...
import 'package:agrip_app/pantallas/productosadmin.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon:
                Icon(Icons.account_circle, size: 45, color: Color(0xFF5AA189)),
            onPressed: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (BuildContext context) => PanPerfil()));
            },
          ),
          PopupMenuButton(
              ...
              switch (value) {
                ...
                case 'cerrarses':
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (BuildContext context) => Regisingres()));
                  break;
              }
            },
          ),
